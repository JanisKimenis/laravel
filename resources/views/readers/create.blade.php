@extends('layout')
@section('title', 'Pievienot lasītāju')

@section('content')
<h1 class="text-2xl font-bold mb-4">Pievienot lasītāju</h1>

<form method="POST" action="{{ route('readers.store') }}" class="bg-white rounded shadow p-6 max-w-lg">
    @csrf
    ...
    <div class="mb-4">
        ...
        <input type="email" name="email" value="{{ old('email') }}" class="w-full border rounded p-2 @error('email') border-red-500 @enderror">
